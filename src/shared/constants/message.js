...
export const descriptionConfirmDialog = (label) =>
  `Tem certeza que deseja ${label}`;
export const errorOnExport = (name) => `Erro ao exportar o arquivo ${name}.`;
export const errorOnLoadField = (fieldName) =>
  `Erro ao carregar o campo ${fieldName}.`;
...
export const usuarioInativo =
  'Usuário inativo, solicite a ativação ao seu responsável.';
...
export const usuarioReenvioSenhaSuccess =
  'Redefinição de senha enviada para o e-mail.';
export const informePontosAvaliacaoError =
  'Informe o(s) Ponto(s) de Avaliação.';
...
export const periodoPermitido = (days) =>
  `O período não deve ser superior a ${days} dias.`;
