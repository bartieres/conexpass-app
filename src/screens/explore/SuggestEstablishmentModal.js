...
export default function SuggestEstablishmentModal({
  visible,
  onClose,
  onSubmit,
  sending,
  ...
  const podeEnviar =
    nome.trim().length > 0 && cidade.trim().length > 0 && !sending;
        ...
        <View style={styles.sheet}>
          ...
          >
            <Text style={styles.subtitle}>
              Não encontrou o estabelecimento que procura? Nos conte onde você
              gostaria de treinar e vamos avaliar a parceria.
            </Text>
            ...
            {success ? (
              <View style={styles.successBox}>
                ...
                <Text style={styles.successText}>
                  Recebemos sua indicação! Vamos avaliar a possibilidade de
                  parceria com esse estabelecimento.
                </Text>
                <TouchableOpacity
